...
final class CommandBusEvents
{
     ...
     * Event listener will receive Gdbots\Pbjx\LifecycleEvent\CommandBus\ValidateCommandEvent
     *
     * @var string
     */
     ...
     * Event listener will receive Gdbots\Pbjx\LifecycleEvent\CommandBus\EnrichCommandEvent
     *
     * @var string
     */
     ...
     * Event listener will receive Gdbots\Pbjx\LifecycleEvent\CommandBus\CommandBusEvent
     *
     * @var string
     */
     ...
     *
     * Event listener will receive Gdbots\Pbjx\LifecycleEvent\CommandBus\CommandBusExceptionEvent
     *
     * @var string
     */
